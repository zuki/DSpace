...
public class DCDate
{
    ...
    public String displayLocalDate(boolean showTime, Locale locale)
    {
        ...
        else if (granularity == DateGran.YEAR)
        {
            if (locale.getLanguage().equals("ja"))
                return String.format("%4d\u5e74", getYear());
            else
        ...
        {
            if (locale.getLanguage().equals("ja"))
                return String.format("%4d\u5e74%2d\u6708", getYear(), getMonth());
            else
        ...
        {
            if (locale.getLanguage().equals("ja"))
                return String.format("%4d\u5e74%2d\u6708%2d\u65e5", getYear(), getMonth(), getDay());
            else
    ...
    public String displayUTCDate(boolean showTime, Locale locale)
    {
        ...
        {
            if (locale.getLanguage().equals("ja"))
                return String.format("%4d\u5e74", getYearUTC());
            else
                return String.format("%4d", getYearUTC());
        }
        else if (granularity == DateGran.MONTH)
        {
            if (locale.getLanguage().equals("ja"))
                return String.format("%4d\u5e74%2d\u6708", getYearUTC(), getMonthUTC());
            else
        ...
        {
            if (locale.getLanguage().equals("ja"))
               return String.format("%4d\u5e74%2d\u6708%2d\u65e5", getYearUTC(), getMonthUTC(), getDayUTC());
            else
                return String.format("%d-%s-%4d", getDay(), monthName, getYearUTC());
        }
    }
