...
<%
    ...
    if (community != null)
    {
        ...
        mode = community.getMetadata("mode");
        journal = community.getMetadata("journal");
...
<%-- ===========================================================
     ...
     =========================================================== --%>
            ...
            <div class="row">
                <label class="col-md-3"><fmt:message key="jsp.tools.edit-community.form.label10"/></label>
                <span class="col-md-9"><input class="form-control" type="text" name="journal" value="<%= Utils.addEntities(journal) %>" size="50"/></span>
            </div><br/>
            <div class="row">
                <label class="col-md-3"><fmt:message key="jsp.tools.edit-community.form.label11"/></label>
                <span class="col-md-9"><input class="form-control" type="checkbox" name="bulletin" value="true" <%= (community != null && community.isBulletin() ? "checked=\"checked\"" : "") %> /></span>
            </div><br/>
            <div class="row">
                <label class="col-md-3"><fmt:message key="jsp.tools.edit-community.form.label12"/></label>
                <span class="col-md-9"><input class="form-control" type="text" name="mode" value="<%= Utils.addEntities(mode) %>" size="50"/></span>
            </div><br/>
<%-- ===========================================================
     Logo
     =========================================================== --%>
